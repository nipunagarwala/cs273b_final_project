  # process_ROI_phenotype_data.R

  # This script is responsible for processing ROI clinical and behavioral phenotype data 
  ...
  write.csv(phenotype.encoded.data, 'processed_ROI_phenotype_data.csv')